...
<asp:Content ID="triBlock" ContentPlaceHolderID="triBlock" runat="server">
	<div id="triBlockContent" class="maincontent">
		<div class="pagebody nonav">
			<div id="TriBlockDemoFull" class="groupcontainer triBlock navnone outline">
				<div class="caption-container hide ">
				</div>
				<div class="subcontainer articles outline first">
					<div class="article">
						<div class="image">
				...
				<!-- end of articles -->
				<div class="subcontainer articles xoutline">
					<div class="article">
						<div class="image">
							<img class="seperator" src="images/placeholder_274.jpg" alt="" />
						</div>
				...
				<!-- end of articles -->
				<div class="subcontainer articles xoutline last">
					<div class="article">
						<div class="image">
							<img class="seperator" src="images/placeholder_274.jpg" alt="" />
						</div>
		...
		<div class="pagebody">
			...
			<div id="TriBlockDemo" class="groupcontainer triBlock navleft xoutline">
				<div class="caption-container hide">
				</div>
				<div class="subcontainer articles outline first">
					<div class="article">
				...
				<!-- end of articles -->
				<div class="subcontainer articles outline">
					<div class="article">
						<div class="image">
							<img class="seperator" src="images/placeholder_200.jpg" />
				...
				<!-- end of articles -->
				<div class="subcontainer articles outline last">
					<div class="article">
						<div class="image">
							<img class="seperator" src="images/placeholder_200.jpg" />
