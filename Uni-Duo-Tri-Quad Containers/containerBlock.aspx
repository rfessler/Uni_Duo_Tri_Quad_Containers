...
<asp:Content ID="containerBlock" ContentPlaceHolderID="containerBlock" runat="server">
	<div id="containerContent">
		...
		<div class="pagebody nonav">
			<div id="containerDemoFull" class="groupcontainer navnone border xinfo xinfoborder xinfoarrow">
		...
		<div class="pagebody">
			...
			<div id="containerDemo" class="groupcontainer navleft border info infoBorder infoarrow">
				<div class="caption-container">
					this is where you put the header.
				</div>
				<div class="text">
